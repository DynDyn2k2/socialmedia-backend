...
public class UserSavePinController {
    ...
    @Autowired
    private UserSavePinRepository usRepository;
    ...
    @PostMapping("/delete")
    public boolean deletePin(@RequestBody UserSavePin userSavePin) {
        List<UserSavePin> list = usRepository.findAll();
        usRepository.delete(list.get(list.size() - 1));
        return true;
    }
